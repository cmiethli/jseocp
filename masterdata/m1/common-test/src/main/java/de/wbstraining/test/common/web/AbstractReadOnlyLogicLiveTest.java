package de.wbstraining.test.common.web;

import static de.wbstraining.common.spring.util.Profiles.CLIENT;
import static de.wbstraining.common.spring.util.Profiles.TEST;
...
import de.wbstraining.test.common.client.template.IRestClient;
