package de.wbstraining.common.security;
...
public class Base64UnitTest {
	...
	public final void whenAuthorizationHeaderIsDecoded_thenResponseIsCorrect() {
		...
		assertThat(authorizationKey.getLeft(), equalTo("kontakt@guenter-zaepernick.de"));
		assertThat(authorizationKey.getRight(), equalTo("guenter-zaepernick.de"));
	}
